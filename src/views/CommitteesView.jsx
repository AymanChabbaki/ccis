...
const scientificCommittee = [
  ...
  { name: "Pr. AHAJJAM Tarik", role: "FSBM-UNIVH2C" },
  ...
  { name: "Pr. AZIZI Mostafa", role: "University Mohammed First" },
  { name: "Pr. Azzouazi Mohamed", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Azzouzi Salma", role: "Uit" },
  ...
  { name: "Pr. BENADDI Hafsa", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Benamri Ichrak", role: "FSBM-UNIVH2C" },
  { name: "Pr. Bentaib Mouhcine", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Bouhsissin Soukaina", role: "ENSAM-UNIVH2C Morocco" },
  { name: "Pr. chafiq Tariq", role: "FSBM-UNIVH2C Morocco" },
  ...
  { name: "Pr. el azami ikram", role: "FSK UIT" },
  ...
  { name: "Pr. elazzaby fouzia", role: "University Ibn Tofail" },
  ...
  { name: "Pr. FAKHRI Youssef", role: "University Ibn Tofail" },
  { name: "Pr. GAYE Ibrahima", role: "Université Alioune DIOP" },
  { name: "Pr. Ghanimi Fadoua", role: "ENSC-UNIVIT Morocco" },
  { name: "Pr. Ghazouani Mohamed", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Hadi Moulay Youssef", role: "Heigher School of Technologu, Ibn Tofail University" },
  { name: "Pr. Hain Mustapha", role: "ENSAM-UNIVH2C Morocco" },
  { name: "Pr. Hanoune Mostafa", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. HAQIQ Abdelkrim", role: "Hassan 1st University, FST, Settat" },
  { name: "Pr. Hattaf Khalid", role: "CRMEF of Casablanca Morocco" },
  { name: "Pr. Hattaf Khalid", role: "CRMEF of Casablanca" },
  { name: "Pr. JDIDOU Youssef", role: "ENSAD-UNIVH2C Morocco" },
  { name: "Pr. JDIDOU Youssef", role: "Hassan II University" },
  { name: "Pr. JOUHARI Mohammed", role: "FSJESK Morocco" },
  { name: "Pr. kandali khalid", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Kandali Khalid", role: "FSBM-UNIVH2C" },
  { name: "Pr. Kandali Khalid", role: "FSBM-UNIVH2C" },
  { name: "Pr. Laaz Naziha", role: "EHTP-UNIVH2C Morocco" },
  { name: "Pr. Laaz Naziha", role: "EHTP-UNIVH2C" },
  { name: "Pr. LAMAAZI Hanane", role: "UAE University" },
  { name: "Pr. Lmati Imane", role: "FST-UNIVH1 Morocco" },
  { name: "Pr. LMATI Imane", role: "FST-UH1 Morocco" },
  { name: "Pr. LO Alla", role: "UADB" },
  ...
  { name: "Pr. Mosbah Mohamed", role: "University of Bordeaux" },
  { name: "Pr. Moukhliss Ghizlane", role: "UNIVH2C" },
  { name: "Pr. Moulay El Hassan Charaf", role: "Ibn Tofail University" },
  ...
  { name: "Pr. RAJAALLAH El Mostafa", role: "ISS-UH1 Morocco" },
  { name: "Pr. RAJAALLAH El Mostafa", role: "University Hassan 1st" },
  { name: "Pr. Rghioui Anass", role: "EHTP-UNIVH2C Morocco" },
  { name: "Pr. Rochd Yassir", role: "ENSA-UNIVH1 Morocco" },
  { name: "Pr. Sadiq Mounir", role: "FSBM-UNIVH2C Morocco" },
  { name: "Pr. Sadiq Abdelalim", role: "Ibn Toufail University, Faculty of sciences" },
  ...
  { name: "Pr. yalid Amal", role: "FLSHB-UNIVH2C Morocco" },
  ...
  { name: "Pr. Zaouch Amal", role: "FSBM-UNIVH2C" },
  { name: "Pr. zougagh hicham", role: "FST Beni Mellal" },
];
